...
public class ProductController {
    ...
    public ResponseEntity<ApiResponse> postHighlightProduct(
        ...
        try {
            productService.postHighlightProduct(id, file, description, isHighlight);
            return ResponseEntity.ok().body(new ApiResponse(true, "Success update highlight product", null));
        } catch (Exception e) {
